...
namespace HKSH.Common.Helper
{
    ...
    public class NpoiExcelHelper
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NpoiExcelHelper" /> class.
        /// </summary>
        ...
        public NpoiExcelHelper(Stream stream)
        {
            FileStream = stream;
        ...
        public static DataTable ExcelSheetToDataTable(ISheet sheet, int skip = 0)
        {
            ...
            if (headRow != null && headRow.Cells.Count > 0)
            {
                ...
                List<CellRangeAddress> mergedRegionList = new List<CellRangeAddress>();
